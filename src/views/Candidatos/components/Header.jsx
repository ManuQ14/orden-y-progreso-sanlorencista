...
export const Header = () => {
  ...
  const handleButtonGoToHome = () => navigate("/inicio");
  const handleButtonOpenMenu = () => setOpenMenu(true);
  const handleButtonCloseMenu = () => setOpenMenu(false);
        ...
        <div className={styles.coverDifuminado}> 
          <nav className={styles.navBar}>
            <ul className={styles.ul}>
              ...
              <img src={EscudoOyP} alt="Escudo OyP" id="EscudoOyP" className={styles.escudooyp} />
              
              <NavLink to="/candidatos" className={({ isActive }) => (isActive ? styles.active : "")}>Candidatos</NavLink>
          ...
          <h2 className={styles.mainh1}>Nuestros Candidatos</h2>
        </div>
      </header>
